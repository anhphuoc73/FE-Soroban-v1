...
import ActionMathAuto from '../../../components/math/action-math-auto';
...
export function SorobanPracticeAutoView() {
   ...
   // bắt đầu chạy bài toán
    ...
    return (
        <Box sx={{display: 'flex',gap: 2}}>
            ...
            <ShowCaculatorAuto open={open} setOpen={setOpen} stringNumber={stringNumber} caculation={caculation} keyLesson={keyLesson} />
