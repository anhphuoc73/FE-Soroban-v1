...
import { isExternalLink } from 'src/routes/utils.js';

import { useBoolean } from 'src/hooks/use-boolean.js';
import { useEventListener } from 'src/hooks/use-event-listener.js';
...
import { SearchNotFound } from 'src/components/search-not-found/index.js';

import { ResultItem } from './result-item.jsx';
import { groupItems, applyFilter, getAllItems } from './utils.js';
